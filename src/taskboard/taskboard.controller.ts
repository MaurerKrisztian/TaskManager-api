...
export class TaskboardController {
    ...
    move(@Param('id') id: string, @Body() moveData: { taskId: string, toBoard: string, index: number }) {
        return this.taskboardService.moveTask(moveData.taskId, moveData.toBoard, moveData.index || 0)
    }
